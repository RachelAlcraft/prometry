...
st.write("We can use the CA distances as well as omega and pre-omega to explore.")
...
geos = "CA:CA+1 CA-1:CA CA:C:N+1:CA+1 CA-1:C-1:N:CA"

#shared_plot.plot_sheet(structures, geos, ("CA:C:N+1:CA+1","CA-1:C-1:N:CA","aa"),("CA[aa|20]:CA+1[aa|20]","CA-1[aa|20]:CA","aa"))
shared_plot.plot_sheet(structures, geos, ("CA:C:N+1:CA+1","CA-1:C-1:N:CA","aa"),("CA:CA+1","CA-1:CA","aa"))
